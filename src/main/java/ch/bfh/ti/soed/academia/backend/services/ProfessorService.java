...
public class ProfessorService {
    ...
    /**
     * Find the Professor by tag.
     *
     * @param tag of the Professor that we are searching
     * @return Professor
     */
    public Professor getProfessorByTag(String tag) {
        TypedQuery<? extends Professor> q = this.em.createNamedQuery("Professor.findByTag", Professor.class);
